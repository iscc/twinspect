...
class Metric(BaseModel):
    name: str | None = Field(None, description="A short readable name of the metric")
    label: str | None = Field(None, description="Short unique label used to reference the metric")
...
class Task(BaseModel):
    ...
    code: str | None = Field(None, description="The genrated hex encoded compact binary code")
    file: str = Field(..., description="The root relative file path of the media file")
    size: int | None = Field(None, description="The file size of the media file in number of bytes")
    time: int | None = Field(
...
class Dataset(BaseModel):
    ...
    label: str | None = Field(None, description="Short label used in tables and as folder name")
    info: str | None = Field(None, description="Human readable information about the dataset")
    ...
    samples: int | None = Field(None, description="Number of samples to install from the dataset")
...
class Configuration(BaseModel):
    ...
    algorithms: list[Algorithm] | None = Field(
    ...
    benchmarks: list[Benchmark] | None = Field(None, description="A list of Benchmarks to run")


class Distribution(BaseModel):
    min: int | None = Field(None, description="The minimum value.")
    max: int | None = Field(None, description="The maximum value.")
    mean: float | None = Field(None, description="The mean value.")
    median: float | None = Field(None, description="The median value.")
