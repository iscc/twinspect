...
??? question "Understanding the Effectiveness Chart" This chart shows how well the algorithm finds
matching files (like duplicates or near-duplicates) without making mistakes.
...
??? question "Understanding the Distribution Chart" This chart shows how the algorithm distinguishes
between files that should match (duplicates) and files that should not match (different content).
