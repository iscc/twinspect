...
!!! info
    ...
    Benchmark results for audio similarity algorithms.
...
Audio similarity algorithms match audio content across different encodings, compressions, and minor
modifications like trimming or fading.
